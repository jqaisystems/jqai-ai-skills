# Legacy Demo Engine Reference

This reference preserves the original desktop-oriented demo architecture for `demo-animation`. Load it only when the user explicitly asks for the legacy demo style instead of the responsive `demo-animation-v2` template.
