...
New here? Start with [`START_HERE.md`](START_HERE.md) for the shortest path from overview to first skill run. Need to choose a route? Use [`docs/examples/visitor-paths.md`](docs/examples/visitor-paths.md). Want one page of public proof assets? Use [`docs/examples/public-proof-index.md`](docs/examples/public-proof-index.md). Want one end-to-end trust path? Use [`docs/examples/first-install-proof.md`](docs/examples/first-install-proof.md). Updating after a release? Use [`docs/examples/update-after-release-proof.md`](docs/examples/update-after-release-proof.md). Want proof for the utility skills? Use [`docs/examples/utility-skill-proof-pack.md`](docs/examples/utility-skill-proof-pack.md). Want a rendered demo proof shape? Use [`docs/examples/demo-animation-v2-walkthrough-sample.md`](docs/examples/demo-animation-v2-walkthrough-sample.md). Want the release-to-showcase handoff path? Use [`docs/examples/release-showcase-handoff-sample.md`](docs/examples/release-showcase-handoff-sample.md). Evaluating whether to trust or install the library? Use [`docs/guides/evaluate-skill-library.md`](docs/guides/evaluate-skill-library.md). Need to pick one safe first install? Use [`docs/guides/first-skill-scorecard.md`](docs/guides/first-skill-scorecard.md). Ready to run the selected skill with fake input? Use [`docs/examples/first-skill-walkthrough.md`](docs/examples/first-skill-walkthrough.md), the [`first-skill candidate pack`](docs/examples/first-skill-candidate/README.md), and its [`expected review`](docs/examples/first-skill-candidate/expected-review.md). Need the short command and link map? Use [`QUICK_REFERENCE.md`](QUICK_REFERENCE.md). Want a clone-to-first-prompt walkthrough? Use [`docs/examples/quick-reference-walkthrough.md`](docs/examples/quick-reference-walkthrough.md). Want to understand the folder contract? Use [`docs/guides/skill-anatomy.md`](docs/guides/skill-anatomy.md). Reviewing a skill before install? Use [`docs/guides/skill-review-checklist.md`](docs/guides/skill-review-checklist.md). Ready to install? Use [`INSTALL.md`](INSTALL.md). Have install questions? Use [`docs/guides/install-faq.md`](docs/guides/install-faq.md). Want to confirm it worked? Use [`docs/guides/install-verification.md`](docs/guides/install-verification.md). Updating an installed skill? Use [`docs/guides/update-installed-skills.md`](docs/guides/update-installed-skills.md). Something not loading? Use [`TROUBLESHOOTING.md`](TROUBLESHOOTING.md). Want release history? Use [`CHANGELOG.md`](CHANGELOG.md). Publishing a release? Use [`RELEASE_CHECKLIST.md`](RELEASE_CHECKLIST.md). Need safety policy? Use [`SECURITY.md`](SECURITY.md). Planning adoption? Use [`ROADMAP.md`](ROADMAP.md), [`SUPPORT.md`](SUPPORT.md), and the refreshed [`skill quality matrix`](docs/skill-quality-matrix.md).
...
For the shortest command map, use [`QUICK_REFERENCE.md`](QUICK_REFERENCE.md). For a route picker, use [`docs/examples/visitor-paths.md`](docs/examples/visitor-paths.md). For a one-page credibility scan, use [`docs/examples/public-proof-index.md`](docs/examples/public-proof-index.md). For one end-to-end install proof trail, use [`docs/examples/first-install-proof.md`](docs/examples/first-install-proof.md). For a post-release refresh trail, use [`docs/examples/update-after-release-proof.md`](docs/examples/update-after-release-proof.md). For lightweight utility examples, use [`docs/examples/utility-skill-proof-pack.md`](docs/examples/utility-skill-proof-pack.md). For responsive demo output proof, use [`docs/examples/demo-animation-v2-walkthrough-sample.md`](docs/examples/demo-animation-v2-walkthrough-sample.md). For release-to-showcase handoff proof, use [`docs/examples/release-showcase-handoff-sample.md`](docs/examples/release-showcase-handoff-sample.md). For a trust and install readiness checklist, use [`docs/guides/evaluate-skill-library.md`](docs/guides/evaluate-skill-library.md). To score the safest first install, use [`docs/guides/first-skill-scorecard.md`](docs/guides/first-skill-scorecard.md). To run the selected skill with fake input, use [`docs/examples/first-skill-walkthrough.md`](docs/examples/first-skill-walkthrough.md), [`docs/examples/first-skill-candidate/README.md`](docs/examples/first-skill-candidate/README.md), and [`docs/examples/first-skill-candidate/expected-review.md`](docs/examples/first-skill-candidate/expected-review.md). For a clone-to-first-prompt walkthrough, use [`docs/examples/quick-reference-walkthrough.md`](docs/examples/quick-reference-walkthrough.md). For install commands, use [`INSTALL.md`](INSTALL.md). For install questions, use [`docs/guides/install-faq.md`](docs/guides/install-faq.md). Before installing unfamiliar skills, use [`docs/guides/skill-review-checklist.md`](docs/guides/skill-review-checklist.md). After installing, verify the folder, reload, and first prompt with [`docs/guides/install-verification.md`](docs/guides/install-verification.md). To update an installed skill, use [`docs/guides/update-installed-skills.md`](docs/guides/update-installed-skills.md). If a skill does not appear after install, use [`TROUBLESHOOTING.md`](TROUBLESHOOTING.md). For a guided first install, use [`docs/guides/one-minute-install.md`](docs/guides/one-minute-install.md). For a fuller decision guide, use [`docs/guides/skill-selection.md`](docs/guides/skill-selection.md). For the complete public catalog, use [`docs/catalog.md`](docs/catalog.md). For current maturity, visible proof, install notes, and safety sensitivity by skill, use [`docs/skill-quality-matrix.md`](docs/skill-quality-matrix.md).
